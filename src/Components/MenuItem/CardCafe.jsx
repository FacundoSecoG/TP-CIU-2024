        ...
        <div className="my-5 w-full max-w-sm min-h-[200px] rounded-lg bg-slate-600 shadow-xl">
            <div className="p-5">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <a href="#" className="text-white focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center bg-teal-700 hover:bg-teal-800 shadow-xl focus:ring-teal-800" 
