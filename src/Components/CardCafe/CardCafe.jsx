...
const CardCafe = ({ cafe }) => {
    return (
        <div class="my-5 w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <a href="#">
                <img class="pb-3 rounded-t-lg" src="https://picsum.photos/400" alt="product image" />
            </a>
            <div class="px-5 pb-5">
                <a href="#">
                    <h5 class="text-3xl font-semibold tracking-tight text-gray-900 dark:text-white">{cafe.nombre}</h5>
                </a>
                <h6 class="mb-3 font-normal text-gray-700 dark:text-gray-400">{cafe.descripcion}</h6>
                ...
                <div class="flex items-center justify-between">
                    <span class="text-3xl font-bold text-gray-900 dark:text-white">${cafe.precio}</span>
